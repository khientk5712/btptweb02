                    ...
                    <div class="col l-12 m-12 c-12">
                        ...
                        <div class="card__body">
                            <form class="row" method="POST" name="received-form" id="received-form" enctype="multipart/form-data">
                                ...
                                <div class="col l-12 m-12 c-12">
                                    <div class="form-group">
                                    <input type="number" name="qtyReceiveda" required value="<?php echo $row_up['qtyReceiveda'];?>">
                                        <label>Số lượng nhận<span>*</span></label>
                                    </div>
                                <div class="col l-12 m-12 c-12">
                                    <div class="form-group">
                                    <input type="number" name="amountReceived" required value="<?php echo $row_up['amountReceived'];?>">
                                ...
                                <div class="col l-12 m-12 c-12">
                                    <div class="form-group">
                                    <input type="text" name="notea" required value="<?php echo $row_up['notea'];?>">
                                        <label>Ghi chú</label>
                                    </div>
                                </div>
