                    ...
                    <div class="col l-12 m-12 c-12">
                        <div class="row">
                            <div class="card__header col l-12 m-12 c-12">
                                <h1 class="card__title">Sửa đổi thông tin nhà sản xuất</h1>
                            </div>
                        </div>
                            ...
                            <form class="row" method="POST" name="makes-form" id="makes-form" enctype="multipart/form-data">
                                <div class="col l-6 m-12 c-12">
                                    <div class="form-group">
                                        <input readonly type="text" name="makeId" required value="<?php echo $row_up['makeId'];?>">
                                ...
                                <div class="col l-12 m-12 c-12">
                                    <div class="form-group">
                                        <input type="text" name="makeName" required value="<?php echo $row_up['makeName'];?>">
                                ...
                                <div class="col l-12 m-12 c-12">
                                    <div class="form-group">
                                        <textarea rows="6" name="remark"><?php echo $row_up['remark'];?></textarea>
                                        <label>Ghi chú</label>
                                    </div>
                                </div>
                                
                                <div class="col l-3 m-12 c-12">
                                    <button class = "form__button" type="submit" name="submit">Lưu thông tin nhà sản xuất</button>
                                </div>
                                <div class="col l-3 m-12 c-12">
